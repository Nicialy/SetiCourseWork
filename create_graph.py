...
names_col = [
    "Bandwidth",
    "Simulated channel delay",
    "Simulated jitter",
    "Error percentage",
    "Packet size in bytes",
    "Planned transmission rate",
    "IP",
    "Number of packets sent",
    "number of packets received",
    "Size of sent data",
    "size of received data in bytes",
    "Time in seconds spent on the test",
    "Actual bandwidth used",
    "Minimum Delay Size",
    "Maximum Delay Size",
    "Average delay time",
    "Test number within the experiment",
]
...
def create_draft(file_name: str, id: UUID):
    ...
    plotly.offline.plot(fig, auto_open=False, filename=filepath + filename)
    return filename
